...
class PDF(FPDF):
    def header(self):
        self.image("ess_pic/ans.png", 0, 0, 8.625)
...
def make_ans_pdf():
    import ans_container
    import qus_container
    answers = ans_container.answer
    questions = qus_container.question
